...
public class clickdealDbContext :
    AbpDbContext<clickdealDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    public clickdealDbContext(DbContextOptions<clickdealDbContext> options)
        : base(options)
    {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        //{
        //    b.ToTable(clickdealConsts.DbTablePrefix + "YourEntities", clickdealConsts.DbSchema);
