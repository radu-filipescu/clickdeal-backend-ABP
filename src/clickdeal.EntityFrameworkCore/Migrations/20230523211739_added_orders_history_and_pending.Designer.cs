...
namespace clickdeal.Migrations
{
    ...
    [Migration("20230523211739_added_orders_history_and_pending")]
    partial class addedordershistoryandpending
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("clickdeal.Categories.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("clickdeal.Orders.UserOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("clickdeal.ProductStocks.ProductStock", b =>
                {
                    ...
                    b.ToTable("AppProductsStock", (string)null);
                });

            modelBuilder.Entity("clickdeal.Products.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("clickdeal.Reviews.Review", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("clickdeal.Orders.UserOrderEntry", b =>
                {
                    b.HasOne("clickdeal.Orders.UserOrder", null)
